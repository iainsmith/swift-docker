...
extension BuiildImageCommandUnitTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__BuiildImageCommandUnitTests = [
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        testCase(BuiildImageCommandUnitTests.__allTests__BuiildImageCommandUnitTests),
